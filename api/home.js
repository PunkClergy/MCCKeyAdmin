...
export const u_carStoreList = (data) => http.get('/carStoreApi/carStoreList', data)
...
export const u_isShowInfo = (data) => http.get('/appHomeApi/isShowInfo', data)
...
export const u_logo = (data) => http.get('/appHomeApi/logo', data)
export const u_getQrcodeImg = (data) => http.get('/appHomeApi/getQrcodeImg', data)
...
export const u_navlist20 = (data) => http.get('/appHomeApi/navlist20', data)
...
export const u_paivateSendRentKey = (data) => http.get('/rentKeyApi/appsendRentKey', data)
